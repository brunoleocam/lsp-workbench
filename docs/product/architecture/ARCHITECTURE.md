...
Roadmap: **UX → analyzer → LS → Agent** — [ADR-006](../adr/ADR-006-roadmap-opcoes-1-2-3.md). Agent: [PDR-006](../pdr/PDR-006-agent-analyzer.md). Catálogo local: [PDR-007](../pdr/PDR-007-catalogo-local-bridge.md).
