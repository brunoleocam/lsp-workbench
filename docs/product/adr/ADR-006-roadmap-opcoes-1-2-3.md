...
Aceito (fases 1–3 foundation entregues; Agent/Demóbile em PDR-006/007)

## Contexto

A plataforma precisa de UX IDE rica, núcleo de análise reutilizável e Language Server opcional. Entregar tudo de uma vez atrasa o valor Demóbile e o Agent.
...
Próximas frentes (após foundation 2–3), em paralelo controlado:

| Doc | Foco |
|-----|------|
| [PDR-006](../pdr/PDR-006-agent-analyzer.md) | Agent consome o mesmo analyzer |
| [PDR-007](../pdr/PDR-007-demobile-catalog-bridge.md) | Bridge catálogo privado → IDE |
